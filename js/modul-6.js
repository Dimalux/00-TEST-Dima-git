...
// ПОЯСНЕННЯ-11    Класи, екземпляр класу, конструктор класу (Конструктор — це метод, який приймає "сирий", щойно створений об'єкт (this) і наповнює його початковими значеннями, роблячи з нього повноцінний екземпляр класу) :
