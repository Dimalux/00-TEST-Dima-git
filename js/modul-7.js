...
// Динамічний HTML-код (неформальний термін, який описує DOM, змінений JavaScript) — це те, що браузер будує на основі статичного HTML + JavaScript. Цей код змінюється під час роботи сторінки. Неформальний термін, який описує DOM, змінений JavaScript
