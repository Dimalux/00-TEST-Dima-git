...
// 1)  Методи "append / prepend" — ДОДАЮТЬ елемент(и) в середину тега або в кінець вмісту, або на початок вмісту (не замінюючи існуючий тег, існуючі дочірні елементи зберігаються),
