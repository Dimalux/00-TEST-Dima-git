...
// ЗАДАЧА 2   Напиші функцію, щоб перевіряла чи присутній такий товар в масиві storage
...
// ПОЯСНЕННЯ-1   Об'єкти.
//               ДОСТУП ДО ВЛАСТИВОСТКЙ ОБ'ЄКТА  :

// 1) ПЕШИЙ СПОСІБ спосіб отримати доступ до властивості об'єкта — це синтаксис "ЧЕРЕЗ КРАПКУ" (використовується тоді, коли ми заздалегідь знаємо ім'я (ключ) властивості, до якої хочемо отримати доступ): 
...
// 2) ДРУГИЙ СПОСІБ отримати доступ до властивості об'єкта — це синтаксис "КВАДРАТНИХ ДУЖОК" (икористовується значно рідше. Як правило, у випадках, коли ім'я властивості заздалегідь не відоме або воно зберігається у змінній) :
...
// console.log(book["title"]); // "The Last Kingdom"      //   синтаксис "КВАДРАТНИХ ДУЖОК" через РЯДОК назви ключа (статичний ключ)

// console.log(book.genres); // ["historical prose", "adventure"]
// console.log(book["genres"]); // ["historical prose", "adventure"]   //   синтаксис "КВАДРАТНИХ ДУЖОК" через РЯДОК назви ключа (статичний ключ)

// const propKey = "author";
// console.log(book.propKey); // undefined
// console.log(book[propKey]); // "Bernard Cornwell"    //   синтаксис "КВАДРАТНИХ ДУЖОК" через ЗМІННУ (яка містить РЯДОК) - (динамічний ключ)


// .........


// Тобто є ДВА  ВАРІАНТИ синтаксису "КВАДРАТНИХ ДУЖОК" :

// .....

// ВАРІАНТ-1  Через рядок (СТАТИЧНИЙ КЛЮЧ) :
// book["genres"] -  через рядок назви ключа

// - Через крапку JavaScript шукає властивість з ТОЧНОЮ НАЗВОЮ ключа.
// - Ключ вказується безпосередньо як рядок.
// - Використовується, коли назва властивості відома заздалегідь.
// - Дає можливість використовувати ключі з пробілами або спецсимволами (наприклад, book["my-key"]), чого не можна зробити через крапку.

// .....

// ВАРІАНТ-2 Через змінну (ДИНАМІЧНИЙ КЛЮЧ) :
// const propKey = "author";
// book[propKey] - через змінну

// - Ключ зберігається у змінній.
// - Використовується, коли назва властивості стає відома під час виконання коду (наприклад, приходить ззовні, з форми, з масиву тощо).
// - Це дозволяє гнучко звертатися до різних властивостей об'єкта динамічно.
...
// Ключ відомий, простий, без пробілів	              book.title (крапка)

// Ключ відомий, але має пробіли або спецсимволи	  book["my key"] (квадратні дужки + рядок)

// Ключ динамічний (зберігається у змінній)	      book[propKey] (квадратні дужки + змінна)
