...
// ПОЯСНЕННЯ-13-1   ДЕСТРУКТУРИЗАЦІЯ ОБ'ЄКТІВ.
//                  Часткова деструктуризація :

// Іноді з масиву необхідно деструктуризувати тільки перші N елементів, а інші зберегти в одну змінну у новий об'єкт.
// Деструктуризуючи об'єкт, можна розпакувати перші необхідні елементи і присвоїти іншу частину елементів об'єкта змінній, використовуючи операцію "...rest" :

// ПРИКЛАД для розуміння :
// Операція деструктуризації з rest оператором (...) витягує властивості firstName та lastName з об'єкта user, а всі інші властивості, що залишилися, поміщаються в новий об'єкт newUser. 
...
// const { firstName, lastName, ...newUser } = user;     //   { id: 1, email: 'test@gmail.com', gender: 'male' }
