...
// - Аутентифікація та сесії - запам'ятовують, що ви ввійшли в обліковий запис (наприклад, "залишити мене в системі").
// - Налаштування та вподобання - тема оформлення, мова сайту, регіон.
// - Відстеження та аналітика - які сторінки ви відвідуєте, як довго залишаєтесь, куди клікаєте.
// - Кошик електронної комерції - запам'ятовують товари, які ви додали до кошика без реєстрації.
// - Персоналізована реклама - запам'ятовують ваші інтереси для показу релевантних оголошень.

// Приклад для розуміння :
// Коли ви обираєте мову "українська" на сайті, він може зберегти cookie: language=uk. При наступному візиті браузер автоматично надішле цей cookie серверу, і сайт одразу покаже українську версію.
