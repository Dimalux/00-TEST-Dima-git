...
// Якщо зараз зупинити проект, зробити зміни (наприклад, додати якісь заголовок), і після цього зберегти втерміналі зміни :
...
// Це якісь пакети, якісь шматочки коди, які ми можем встановлювати собі в проект і в подальшому якось використовувати. Якщо потрібен якісь пакет, наприклад "nanoid" (цей пакет існує для генерації випадкових ID), пишимо назву в рядку пошуку браузера :
